...
<head>
  ...
  @include('user.partials.seo-meta')
...
<body>
  ...
  <button class="toTopButton js-top-button is-hidden" type="button" aria-label="Lên đầu trang">
  ...
  @include('user.partials.floating-support')
